...
function Chronometer:WarlockSetup()
	...
	self:AddTimer(self.SPELL, BS["Curse of Recklessness"], 120, 1,0,0, { gr=2, rc=true, also={ BS["Curse of Agony"] } })
	self:AddTimer(self.SPELL, BS["Curse of Shadow"],       300, 1,0,0, { gr=2, rc=true, also={ BS["Curse of Agony"] } })
	...
	self:AddTimer(self.SPELL, BS["Curse of the Elements"], 300, 1,0,0, { gr=2, rc=true, also={ BS["Curse of Agony"] } })
